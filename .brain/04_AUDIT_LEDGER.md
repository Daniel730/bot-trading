...
8. Does the dashboard clearly distinguish shadow paper mode from Alpaca paper-broker mode in runtime labels, settings copy, health payloads, and startup logs?

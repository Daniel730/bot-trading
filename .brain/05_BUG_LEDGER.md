...
| ISSUE-0019 | Closing trades overwrites per-leg metadata | `src/services/persistence_service.py::close_trade`, `tests/unit/test_persistence_service.py::test_close_trade_preserves_entry_metadata` | FIXED | P2 |

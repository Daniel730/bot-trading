...
@pytest.mark.asyncio
async def test_neutral_sec_weight_does_not_drag_pair_confidence_below_agent_consensus(monkeypatch):
    monkeypatch.setattr(settings, "PAPER_TRADING", False)

    orchestrator = Orchestrator()
    input_data = {
        "signal_context": {
            "signal_id": "neutral_sec_mab_drag_1",
            "ticker_a": "AAPL",
            "ticker_b": "MSFT",
            "hedge_ratio": 1.0,
            "z_score": 5.0,
